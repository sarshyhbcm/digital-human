<template>
  <div class="knowledge-page">
    ...
    <el-card shadow="hover">
      ...
      <el-table v-if="!loading" :data="documents" stripe style="width: 100%; margin-top: 16px;">
...
import { getKbDocuments, importKbDocument, deleteKbDocument } from '../kb/api'
...
.import-hint p { margin: 2px 0; color: var(--text-muted); font-size: 13px; }
</style>
